...
WebUI.click(findTestObject('Object Repository/Page_Graficacin - GRIISOFT/button_Eliminar'))

WebUI.click(findTestObject('Object Repository/Page_Graficacin - GRIISOFT/button_Aceptar'))
