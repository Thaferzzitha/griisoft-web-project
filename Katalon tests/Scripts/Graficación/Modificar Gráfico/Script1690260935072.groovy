...
WebUI.click(findTestObject('Object Repository/Page_Dashboard - GRIISOFT/a_Historial de Grficos'))

WebUI.click(findTestObject('Object Repository/Page_Graficacin - GRIISOFT/button_Editar'))

WebUI.setText(findTestObject('Object Repository/Page_Graficacin - GRIISOFT/input_Ttulo_title'), 'Atractor de Rossler Modificado')

WebUI.setText(findTestObject('Object Repository/Page_Graficacin - GRIISOFT/input_Nmero de Puntos_pointsNumber'), '100000')
...
WebUI.click(findTestObject('Object Repository/Page_Graficacin - GRIISOFT/button_Ver'))
