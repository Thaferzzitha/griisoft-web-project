...
WebUI.click(findTestObject('Object Repository/Page_Perfil - GRIISOFT/button_CrearRegenerar token'))

WebUI.click(findTestObject('Object Repository/Page_Perfil - GRIISOFT/span_Copiar'))

WebUI.click(findTestObject('Object Repository/Page_Perfil - GRIISOFT/button_OK'))
