...
WebUI.click(findTestObject('Object Repository/Page_Dashboard - GRIISOFT/button_Thala Zrate'))

WebUI.click(findTestObject('Object Repository/Page_Dashboard - GRIISOFT/a_Perfil'))

WebUI.setText(findTestObject('Object Repository/Page_Perfil - GRIISOFT/input_Nombre_name'), 'Thalía Fernanda Zárate')
