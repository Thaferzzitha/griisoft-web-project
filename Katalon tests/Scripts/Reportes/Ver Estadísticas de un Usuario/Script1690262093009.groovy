...
WebUI.selectOptionByValue(findTestObject('Object Repository/Page_Dashboard - GRIISOFT/select_BarrasDispersin'), 'scatter', 
    true)
...
WebUI.click(findTestObject('Object Repository/Page_Dashboard - GRIISOFT/div_Filtro por fecha desdeFiltro por fecha _29f7df'))
